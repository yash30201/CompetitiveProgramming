...
void solve() {
    ...
    vv<int> dp(n + 1, v<int>(3, -INF));
    dp[0][0] = 0;
    dp[2][1] = ((a[0][0] + a[0][1] + a[1][0]) > 1 ? 1 : 0);
    dp[2][2] = ((a[0][0] + a[1][1] + a[1][0]) > 1 ? 1 : 0);
    FOR(i, 2, n) {
        dp[i + 1][0] = max(
            dp[i+1][0],
            dp[i][2] + ((a[0][i-1] + a[0][i] + a[1][i]) > 1 ? 1 : 0)
        );
        dp[i + 1][0] = max(
            dp[i+1][0],
            dp[i][1] + ((a[0][i] + a[1][i] + a[1][i-1]) > 1 ? 1 : 0));
        dp[i + 1][0] = max(
            dp[i+1][0],
            dp[i - 2][0]
                + ((a[0][i-2] + a[0][i-1] + a[0][i]) > 1 ? 1 : 0)
                + ((a[1][i-2] + a[1][i-1] + a[1][i]) > 1 ? 1 : 0)
        );
        dp[i + 1][1] = max(
            dp[i+1][1],
            dp[i-1][0] + ((a[0][i-1] + a[0][i] + a[1][i-1]) > 1 ? 1 : 0)
        );
        if (i > 2) dp[i + 1][1] = max(
            dp[i+1][1],
            dp[i-2][1]
                + ((a[0][i-2] + a[0][i-1] + a[0][i]) > 1 ? 1 : 0)
                + ((a[1][i-3] + a[1][i-2] + a[1][i-1]) > 1 ? 1 : 0)
        );

        dp[i + 1][2] = max(
            dp[i+1][2],
            dp[i-1][0] + ((a[0][i-1] + a[1][i] + a[1][i-1]) > 1 ? 1 : 0)
        );
        if (i > 2) dp[i + 1][2] = max(
            dp[i+1][2],
            dp[i-2][2]
                + ((a[1][i-2] + a[1][i-1] + a[1][i]) > 1 ? 1 : 0)
                + ((a[0][i-3] + a[0][i-2] + a[0][i-1]) > 1 ? 1 : 0)
        );
    }
    op(dp[n][0]);
    return;
